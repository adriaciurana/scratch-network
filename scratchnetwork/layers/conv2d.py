...
class Conv2D(Layer):
	...
	def computeSize(self):
		...
		return ((self.in_size[0][0] - self.kernel_size[0] + 2*self.padding_size[0])//self.stride[0] + 1, (self.in_size[0][1] - self.kernel_size[1] + 2*self.padding_size[1])//self.stride[1] + 1, self.num_filters)
